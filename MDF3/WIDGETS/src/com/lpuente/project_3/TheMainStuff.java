...
public class TheMainStuff extends Activity implements SensorEventListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_stuff_lay);
...
/////////////////////////SETUP FOR TAB 1////////////////////////////////////////////////
        ...
        mP = MediaPlayer.create(TheMainStuff.this, R.raw.mxpx);
...
/////////////////////////SETUP FOR TAB 2////////////////////////////////////////////////
        ...
        notifyB.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Context context = TheMainStuff.this;
        ...
        showLocation.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				gps = new GPSclass(TheMainStuff.this);
